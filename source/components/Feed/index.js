...
class Feed extends Component {
    ...
    removePost = async (post) => {
        ...
        try {
            ...
            this.setState((prevState) => ({
                posts: prevState.posts.filter((item) => item.id !== post.id),
            }));
        } catch (e) {
            console.error(e.text);
        } finally {
                ...
                <CSSTransition
                    ...
                    <Catcher>
                        <Post
                            ...
                            userName={`${post.currentUserFirstName} ${
                                post.currentUserLastName
                                }`}>
        ...
        return (
            <section className={Styles.feed}>
                ...
                <Transition
                    ...
                    timeout={3000}>
                    <Composer
                        onPost={this.addPostAsync}
                        onRemoveAllPosts={this.removeAllPosts}
                    />
                </Transition>
