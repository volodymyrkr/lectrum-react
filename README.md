...
<div align="center">
  <!-- Package version -->
    <img src="https://img.shields.io/github/package-json/v/lectrum/react-intensive-boilerplate.svg?longCache=true&style=flat-square"
      alt="Package version" />
  <!-- Last commit -->
    <img src="https://img.shields.io/github/last-commit/lectrum/react-intensive-boilerplate.svg?longCache=true&style=flat-square"
      alt="Last commit" />
  <!-- Dependencies -->
    ...
    <tbody>
        <tr>
            <td>
                ...
                <p>
                    📸&nbsp;Вместе мы построим свой <b><code>Facebook</code></b> с основным фокусом на глубокое изучение самых тонких технологий работы React.
...
6. Склонируй и запусти этот проект: `git clone https://github.com/Lectrum/react-intensive-boilerplate.git`;
7. Чтобы перейти в директорию с проекта, после клонирования выполни команду `cd react-intensive-boilerplate`;
...
10. Перейди в браузер и открой страничку [http://localhost:3000](http://localhost:3000/). Когда страничка загрузится, ты увидишь страницу с сообщением «Добро пожаловать на интенсив по React».
